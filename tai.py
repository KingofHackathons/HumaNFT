...
<|container|
# HumaNFT **Analysis**{: .color-primary} Dashboard
...
<ticker|
#### Selected **NFT**{: .color-primary}

Please enter a valid NFT name: 
<|{selected_stock}|input|label=Stock|on_action=get_data_from_range|> 


or choose from the list:

<|{selected_stock}|toggle|lov=BEN;ZEUS;HEINY; WOOF; HOG; ROCK|on_change=get_data_from_range|>
|ticker>
...
gui.run(dark_mode=False, title="Stock Visualization", use_reloader=True)